            ...
            <div class="card-body">
                <form action="{{ route('AddUser')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="full_name" value="{{old('full_name')}}" class="form-control" id="formGroupExampleInput" placeholder="Enter your Full Name">
                        @error('full_name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password_confirmation" class="form-control" id="formGroupExampleInput2" placeholder="Re-enter Password to confirm">
